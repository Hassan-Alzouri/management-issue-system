...
namespace hassan11244WebApp1.Account
{
    public partial class login : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            //Note its comment after 
...
*/
         private void createAdminAndUserByDefault()
        {
            ...
            try
            {
                ...
                string strAppName = "/hassan11244WebApp1";
                string strAdminUserName = "ali";  //txtUserName.Text;
                string strAdminPassword = "123"; //txtPassword.Text;
                string strRoleName = "admin";
                string strEmail = "hassanalzourei@gmail.com";
