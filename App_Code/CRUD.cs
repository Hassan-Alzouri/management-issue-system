...
/// </summary>
/// 
namespace hassan11244WebApp1.App_Code
{
   public class CRUD
    {
        public string myVar2 = "Saudi Arabia";
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["hassan11244ConStr"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["hassan11244ConStr"].ConnectionString);
        public CRUD()
        {
            //
        ...
        public int InsertUpdateDelete(string mySql, Dictionary<string, object> myPara) //8
        {
            ...
            return rtn;*/
            int rtn = 0;
            string conStr = ConfigurationManager.ConnectionStrings["hassan11244ConStr"].ConnectionString;
        ...
        {
            object result = null;
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["hassan11244ConStr"].ConnectionString))
            {
